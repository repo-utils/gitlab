...
MergeRequest.prototype.changes = function (params, callback) {
  if (!params.id) throw new Error("project 'id' is required");
  if (!params.merge_request_id) throw new Error("mergerequests 'merge_request_id' is required");
  this.client.request('get', this.onePath + '/changes', params, callback);
}
