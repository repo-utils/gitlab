 ...
 * @param {Object} params
 *  - {String} id The ID of a project
 *  - {String} branch_name The name of the branch
 *  - {String} ref Create branch from commit SHA or existing branch
 * @param {Function} callback
 */
Repository.prototype.createBranch = function (params, callback) {
  params.type = 'branches';
