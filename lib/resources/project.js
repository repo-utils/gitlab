...
Project.prototype.enableRunner = function(params, callback) {
  this.client.request('post', this.onePath +'/runners', params, callback);
};

Project.prototype.disableRunner = function(params, callback) {
  this.client.request('delete', this.onePath +'/runners/:runner_id', params, callback);
};

Project.prototype.runners = function(params, callback) {
  this.client.request('get', this.onePath +'/runners', params, callback);
};